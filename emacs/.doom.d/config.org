...
Here's the code to implement this, in courtesy of [[https://takeonrules.com/2023/01/22/hacking-org-mode-export-for-footnotes-as-sidenotes/][this blog post]]:

#+begin_src emacs-lisp
(defun hp/org-export-to-hugo-sidenote (footnote-reference _contents info)
...
(advice-add #'org-blackfriday-footnote-reference
            :override #'hp/org-export-to-hugo-sidenote
            '((name . "wrapper")))
