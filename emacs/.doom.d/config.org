...
#+RESULTS:
: --with-modules --with-json --with-mailutils --with-rsvg --with-native-compilation --with-pgtk --with-xinput2 --with-xwidgets --with-gif
* Fundamental setups
** Some good defaults
...
#+end_src
These are blindly copied elsewhere:
#+begin_src emacs-lisp
...
- TODO Fix export behavior of Org-roam links
** R
#+begin_src emacs-lisp
(use-package! ess
  :config
